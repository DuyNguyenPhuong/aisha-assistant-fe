          ...
          <DropdownMenuContent
            ...
            {teams.map((team, index) => (
              <DropdownMenuItem
                ...
                {team.name}
                <DropdownMenuShortcut className="group-hover:text-accent-foreground">⌘{index + 1}</DropdownMenuShortcut>
              </DropdownMenuItem>
            ))}
            <DropdownMenuSeparator />
            <DropdownMenuItem className='gap-2 p-2 group'>
              ...
              <div className='font-medium text-muted-foreground group-hover:text-accent-foreground'>Add team</div>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </SidebarMenuItem>

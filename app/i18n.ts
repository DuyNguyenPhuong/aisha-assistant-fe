    ...
    resources: {
      en: {
        translation: {
          ...
          "riverMapSubTitle": "Interactive river map showing coordinates along an 8000m waterway",
          "riverMapFeature1Title": "Interactive Navigation",
          "riverMapFeature1Desc": "Move your mouse over the river to see precise coordinates",
          "riverMapFeature2Title": "8000m Length",
          "riverMapFeature2Desc": "Simulated river spanning 8 kilometers with natural curves",
          "riverMapFeature3Title": "Real Coordinates",
          "riverMapFeature3Desc": "Live latitude and longitude display based on Hanoi region",
          "address": "Address",
      ...
      ru: {
        translation: {
          ...
          "askAnything": "Задавайте вопросы о качестве воды, процессах очистки или создании отчетов.",
          ...
          "riverMapSubTitle": "Интерактивная карта реки с координатами вдоль 8000-метрового водного пути",
          "riverMapFeature1Title": "Интерактивная навигация",
          "riverMapFeature1Desc": "Наведите курсор на реку, чтобы увидеть точные координаты",
          "riverMapFeature2Title": "Длина 8000м",
          "riverMapFeature2Desc": "Симулированная река протяженностью 8 км с естественными изгибами",
          "riverMapFeature3Title": "Реальные координаты",
          "riverMapFeature3Desc": "Отображение широты и долготы в реальном времени для региона Ханоя",
          "address": "Адрес",
      ...
      "vi": {
        "translation": {
          ...
          "askAnything": "Hãy hỏi bất kỳ điều gì về chất lượng nước, quy trình xử lý, hoặc tạo báo cáo.",
          ...
          "riverMapSubTitle": "Bản đồ sông tương tác hiển thị tọa độ dọc theo dòng sông dài 8000m",
          "riverMapFeature1Title": "Điều hướng Tương tác",
          "riverMapFeature1Desc": "Di chuyển chuột qua sông để xem tọa độ chính xác",
          "riverMapFeature2Title": "Dài 8000m",
          "riverMapFeature2Desc": "Mô phỏng dòng sông trải dài 8 km với các khúc cua tự nhiên",
          "riverMapFeature3Title": "Tọa độ Thực",
          "riverMapFeature3Desc": "Hiển thị kinh độ và vĩ độ trực tiếp dựa trên khu vực Hà Nội",
          "address": "Địa chỉ",
